...
#adding in a Decision Tree Classifier, setting its max_depth to 9, and random_state=2, 
#but not altering any other setting.
#Make sure you add in the benchmark and drawPlots call for our new classifier as well.
#
from sklearn import tree
tee = tree.DecisionTreeClassifier(max_depth=4, random_state=2)
tee.fit(X_train, y_train)
score = tee.score(X_test, y_test)
print (score)

benchmark(tee, X_train, X_test, y_train, y_test, 'DecisionTree')
drawPlots(tee, X_train, X_test, y_train, y_test, 'DecisionTree')
