...
#
#plt.imshow(X_test.corr(), cmap=plt.cm.Blues, interpolation='nearest')
...
#model = SVC(kernel='rbf', C = 1, gamma = 0.0016) = 0.986080178174
...
# data. What accuracy score do you get now? = 0.846881959911
...
# assignment one last time. What's the accuracy score this time? = 0.854120267261
# Surprised?
