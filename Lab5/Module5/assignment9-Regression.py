...
#print(X.head())
#print(X.dtypes)
#print X.isnull().sum() #To check for missing values!
...
X_train, X_test, y_train, y_test = train_test_split(s1, s2, test_size=0.30, random_state = 7)
...
#print(s2.head())
from sklearn.cross_validation import train_test_split
X_train, X_test, y_train, y_test = train_test_split(s3, s4, test_size=0.30, random_state = 7)
...
#print(s2.head())
from sklearn.cross_validation import train_test_split
X_train, X_test, y_train, y_test = train_test_split(s5, s6, test_size=0.30, random_state = 7)
...
#
s7 = X[['Room.Board', 'Enroll']]
s8 = X[['Accept']]
#print(s1.head())
#print(s2.head())
from sklearn.cross_validation import train_test_split
X_train, X_test, y_train, y_test = train_test_split(s7, s8, test_size=0.30, random_state = 7)
...
drawPlane(model, X_test, y_test, "Room&Board,Enroll(Accept)", score)
